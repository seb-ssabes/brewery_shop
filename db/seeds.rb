...
beers = [
  ...
  { title: 'Majestic Midnight - Imperial Stout', price: 2.80 , description: 'Majestic Midnight Stout struts in with rich, roasted malt flavors, like a chocolate and coffee love affair. This imperial stout is as bold as it is smooth, with a touch of dark fruit sweetness. Pouring as dark as a moonless night, it\'s the perfect companion for late-night musings or impressing your beer-snob friends. It\'s big, it\'s bold, and it\'s got a royal swagger that commands respect.', image: 'Stout.jpg', abv: 7.3, ibu: 58, hops: "Magnum, Fuggle and E. K. Goldings" },
